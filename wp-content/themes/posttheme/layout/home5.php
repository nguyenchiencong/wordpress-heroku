...
<?php endwhile; ?>
	...
	if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
							...
							<?php if ( has_post_thumbnail() ) { ?>
							<a href="<?php the_permalink() ?>"> <?php the_post_thumbnail('category-thumb-2'); ?></a>
						<?php } ?>
						</div>
							<h2 class="post-title-2"><a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
							<div class="meta-info-date"><?php the_time('F j Y,') ?><a href="<?php comments_link(); ?>"> <?php comments_number ('0','1','%'); ?> Comments</a></div>
							<div class="post-description-2"><?php the_content_limit(190); ?></div>
							 <div class="post-read-link-2"><a href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent Link to <?php the_title(); ?>">Read more &rarr;</a></div>
